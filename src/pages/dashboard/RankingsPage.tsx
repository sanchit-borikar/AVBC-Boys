...
// Mock Data
const mockRankings = [
  { rank:1,  city:"Pune",       state:"Maharashtra", sector:"industrial", score:78, co2e:3800,  who:false, cpcb:false, trend:"+2%",  direction:"up", chain:true,  tx:"MNOPQR789..." },
  { rank:2,  city:"Chennai",    state:"Tamil Nadu",  sector:"industrial", score:71, co2e:4200,  who:false, cpcb:false, trend:"-5%",  direction:"down", chain:false, tx:"" },
  { rank:3,  city:"Bengaluru",  state:"Karnataka",   sector:"energy",     score:68, co2e:5100,  who:false, cpcb:true,  trend:"+1%",  direction:"up", chain:true,  tx:"XYZ789..." },
  { rank:4,  city:"Hyderabad",  state:"Telangana",   sector:"transport",  score:55, co2e:7300,  who:true,  cpcb:false, trend:"-2%",  direction:"down", chain:false, tx:"" },
  { rank:5,  city:"Mumbai",     state:"Maharashtra", sector:"transport",  score:42, co2e:8420,  who:true,  cpcb:false, trend:"+8%",  direction:"up", chain:true,  tx:"ABCDEF123..." },
  { rank:6,  city:"Ahmedabad",  state:"Gujarat",     sector:"industrial", score:38, co2e:11200, who:true,  cpcb:true,  trend:"+15%", direction:"up", chain:true,  tx:"STUVWX012..." },
  { rank:7,  city:"Delhi",      state:"Delhi",       sector:"industrial", score:25, co2e:13695, who:true,  cpcb:true,  trend:"+22%", direction:"up", chain:true,  tx:"OUXORCLW..." },
  { rank:8,  city:"Kolkata",    state:"West Bengal", sector:"industrial", score:31, co2e:15200, who:true,  cpcb:true,  trend:"+18%", direction:"up", chain:true,  tx:"QRSTUV456..." }
];

const mockStateSummary = [
  { state: "Kerala",        cities: 12, avgScore: 74 },
  { state: "Tamil Nadu",    cities: 18, avgScore: 68 },
  { state: "Karnataka",     cities: 15, avgScore: 65 },
  { state: "Maharashtra",   cities: 22, avgScore: 58 },
  { state: "Gujarat",       cities: 14, avgScore: 52 },
  { state: "Telangana",     cities: 10, avgScore: 48 },
  { state: "Uttar Pradesh", cities: 19, avgScore: 41 },
  { state: "West Bengal",   cities: 12, avgScore: 35 },
];

const mostImproved = [
  { city: "Chennai", state: "Tamil Nadu", points: 12, score: 71 },
  { city: "Pune", state: "Maharashtra", points: 8, score: 78 },
  { city: "Kochi", state: "Kerala", points: 7, score: 74 },
  { city: "Bengaluru", state: "Karnataka", points: 5, score: 68 },
  { city: "Jaipur", state: "Rajasthan", points: 4, score: 62 },
];

const mostDeclined = [
  { city: "Delhi", state: "Delhi", points: 15, score: 25 },
  { city: "Kolkata", state: "West Bengal", points: 12, score: 31 },
  { city: "Ahmedabad", state: "Gujarat", points: 9, score: 38 },
  { city: "Kanpur", state: "Uttar Pradesh", points: 7, score: 36 },
  { city: "Patna", state: "Bihar", points: 6, score: 40 },
];
    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">City-level emission compliance across 188 Indian cities · Updated every 30s</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm border-l-[4px] border-l-[#22c55e]">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-2xl font-display font-bold text-slate-900 leading-tight">Pune</p>
              <p className="text-[11px] mt-1 font-medium text-slate-500">Score: 78 · Maharashtra</p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm border-l-[4px] border-l-[#ef4444]">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-2xl font-display font-bold text-slate-900 leading-tight">Kolkata</p>
              <p className="text-[11px] mt-1 font-medium text-slate-500">Score: 31 · West Bengal</p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm border-l-[4px] border-l-[#3b82f6]">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-2xl font-display font-bold text-slate-900 leading-tight">Chennai</p>
              <p className="text-[11px] mt-1 font-medium text-blue-500">↑ +12 points vs last month</p>
            </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm border-l-[4px] border-l-[#f59e0b]">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-2xl font-display font-bold text-slate-900 leading-tight">52/100</p>
              <p className="text-[11px] mt-1 font-medium text-amber-500">WARNING — needs improvement</p>
            </div>
      ...
      <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-sm overflow-hidden relative">
        <div className="p-5 border-b border-[#e2e8f0] flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium text-slate-500 hidden sm:block">Showing 1-20 of 188 cities</span>
